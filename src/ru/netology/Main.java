...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println(myCallable1 + "выполнил задачу " + task1.get() + " раз(а)");
            System.out.println(myCallable2 + "выполнил задачу " + task2.get() + " раз(а)");
            System.out.println(myCallable3 + "выполнил задачу " + task3.get() + " раз(а)");
            System.out.println(myCallable4 + "выполнил задачу " + task4.get() + " раз(а)");
        ...
        System.out.println("Завершил потоки!");
        threadPool.shutdown();
    }
}
